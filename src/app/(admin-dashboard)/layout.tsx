...
function BellIcon({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      <path d="M12 4a5 5 0 0 0-5 5v2.1c0 .7-.2 1.4-.6 2l-1.1 1.6A1 1 0 0 0 6.2 16h11.6a1 1 0 0 0 .9-1.3l-1.1-1.6a3.4 3.4 0 0 1-.6-2V9a5 5 0 0 0-5-5Zm0 16a2.5 2.5 0 0 0 2.4-2h-4.8A2.5 2.5 0 0 0 12 20Z" fill="currentColor" />
    </svg>
  );
}
...
const supportItems = [
  ...
  { label: "Privacy Policy", href: "/admin-dashboard/privacy-policy", icon: ShieldIcon },
  { label: "Contact Message", href: "/admin-dashboard/contact-message", icon: MailIcon },
